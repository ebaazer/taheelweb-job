...
var KTAppCalendar = function () {
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    ...
                                    axios.post(baseurl + 'calendar/events_ajx/create', data_ev, {
                                        headers: {
    ...
    const handleViewEvent = () => {
        ...
        // Populate view data
        //viewTopic.innerText = data.topic;
        ...
        viewDeleteButton.addEventListener('click', e => {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "post",
                        url: baseurl + "calendar/events_delete/" + data.id,
                        dataType: "json",
                        encode: true,
                    }).done(function (data) {
    ...
    // Populate form 
    const populateForm = () => {
        eventTopic.value = data.topic ? data.topic : '';
    ...
    return {
        ...
        init: function () {
            ...
            eventTopic = form.querySelector('[name="topic"]');
            ...
            viewTopic = viewElement.querySelector('[data-kt-calendar="topic"]');
