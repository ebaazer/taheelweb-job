...
<header class="header-area style-1 dashboard-header">
    ...
    <div class="main-menu">
        <ul class="menu-list">
            ...
            <li class="position-inherit">
                <a href="#" class="drop-down">FOR SALE</a>
                ...
                <div class="mega-menu">
                    <ul class="menu-row">
                        <li class="menu-single-item">
                            ...
                            <ul>
                                ...
                                <li class="explore-more-btn">
                                    <a href="poperty-listing-no-sidebar.html">Explore More <i class="bi bi-arrow-right-short"></i></a>
                                </li>
                            </ul>
                        </li>
                        <li class="menu-single-item">
                        ...
                        <li class="menu-single-item d-lg-block d-none">
                            <div class="menu-insight">
                                <span>
                                ...
                                <div class="insight-wrap">
                                    ...
                                    <div class="explore-more-btn">
                                        <a href="blog-details">Read Insight <i class="bi bi-arrow-right-short"></i></a>
                                    </div>
                                </div>
                            </div>
                        </li>
            ...
            <li class="position-inherit">
                <a href="#" class="drop-down">FOR RENT</a>
                <i class="bi bi-plus dropdown-icon d-lg-none d-block"></i>
                <div class="mega-menu">
                    <ul class="menu-row">
                        <li class="menu-single-item">
            ...
            <li class="position-inherit">
                <a href="#" class="drop-down">PROPERTY</a>
                <i class="bi bi-plus dropdown-icon d-lg-none d-block"></i>
                <div class="mega-menu">
                    <ul class="menu-row">
                        <li class="menu-single-item">
            ...
            <li class="menu-item-has-children">
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu">
                            <li><a href="poperty-deatils1.html">Property Details 01</a></li>
                            <li><a href="poperty-deatils2.html">Property Details 02</a></li> 
                        </ul>
                    </li>
                    <li>
                        ...
                        <i class="d-lg-none d-flex bi bi-plus dropdown-icon"></i>
                        <ul class="sub-menu">
                            <li><a href="property-listing-left-sidebar.html">Property Listing Left Sidebar</a></li>
                            <li><a href="property-listing-right-sidebar.html">Property Listing Right Sidebar</a></li>
                            <li><a href="poperty-listing-no-sidebar.html">Property Listing No Sidebar</a></li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <i class="d-lg-none d-flex bi bi-plus dropdown-icon"></i>
                        <ul class="sub-menu">
                            <li><a href="poperty-map-left.html">Property Map Left</a></li>
                            <li><a href="poperty-map-right.html">Property Map Right</a></li>
                            <li><a href="poperties-with-map.html">Property Map Top</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a href="pricing-checkout.html ">Pricing Checkout</a></li>
        ...
        <div class="topbar-right d-lg-none d-block">
            <button type="button" class="modal-btn header-cart-btn" data-bs-toggle="modal" data-bs-target="#logInModal01">
            ...
            <a class="primary-btn3" href="dashboard-add-property.html">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14">
                <g clip-path="url(#clip0_485_1365)">
    ...
    <div class="nav-right d-flex jsutify-content-end align-items-center">   
        <button type="button" class="modal-btn header-cart-btn d-lg-flex d-none" data-bs-toggle="modal" data-bs-target="#logInModal01">
            <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M14.4311 12.759C15.417 11.4291 16 9.78265 16 8C16 3.58169 12.4182 0 8 0C3.58169 0 0 3.58169 0 8C0 12.4182 3.58169 16 8 16C10.3181 16 12.4058 15.0141 13.867 13.4387C14.0673 13.2226 14.2556 12.9957 14.4311 12.759ZM13.9875 12C14.7533 10.8559 15.1999 9.48009 15.1999 8C15.1999 4.02355 11.9764 0.799983 7.99991 0.799983C4.02355 0.799983 0.799983 4.02355 0.799983 8C0.799983 9.48017 1.24658 10.8559 2.01245 12C2.97866 10.5566 4.45301 9.48194 6.17961 9.03214C5.34594 8.45444 4.79998 7.49102 4.79998 6.39995C4.79998 4.63266 6.23271 3.19993 8 3.19993C9.76729 3.19993 11.2 4.63266 11.2 6.39995C11.2 7.49093 10.654 8.45444 9.82039 9.03206C11.5469 9.48194 13.0213 10.5565 13.9875 12ZM13.4722 12.6793C12.3495 10.8331 10.3188 9.59997 8.00008 9.59997C5.68126 9.59997 3.65049 10.8331 2.52776 12.6794C3.84829 14.2222 5.80992 15.2 8 15.2C10.1901 15.2 12.1517 14.2222 13.4722 12.6793ZM8 8.79998C9.32551 8.79998 10.4 7.72554 10.4 6.39995C10.4 5.07444 9.32559 3.99992 8 3.99992C6.6744 3.99992 5.59997 5.07452 5.59997 6.40003C5.59997 7.72554 6.67449 8.79998 8 8.79998Z"></path>
            </svg>
            REGISTER/ LOGIN                  
        </button>         
        <a class="primary-btn3 d-lg-flex d-none" href="dashboard-add-property.html">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14">
            <g clip-path="url(#clip0_485_1365)">
...
<div class="dashboard-wrapper">
    <div class="dashboard-sidebar-wrapper">
        <div class="dashboard-sidebar-logo">
            <a href="index.html">
                <img class="d-md-block d-none" src="assets/img/dashboard/icon/dashboard-sidebar-logo.svg" alt="">
            </a>
            <a href="index.html">
                <img class="d-md-none d-block" src="assets/img/dashboard/icon/dashboard-sidebar-sm-logo.svg" alt="">
            </a>
        </div>
            ...
            <ul>
                ...
                <li>
                    <a href="dashboard-my-listing.html">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
                        <mask id="mask0_920_506" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="18" height="18">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="counter-single four">
                                ...
                                <img src="assets/img/dashboard/icon/counter-area-top-vector.svg" alt="" class="counter-area-vector">
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <td data-label="Property Info">
                                        <div class="property-info-wrapper">
                                            ...
                                            <div class="property-info-content">
                                                <div class="location">
                                                    <a href="property-listing-left-sidebar.html"><i class="bi bi-geo-alt"></i>  Panama City</a>
                                                </div>
                                                <h6><a href="property-listing-left-sidebar.html">Willow Creek Residence</a></h6>
                                                <a href="poperty-deatils1.html" class="view-details">
                                    ...
                                    <td data-label="Property Info">
                                        <div class="property-info-wrapper">
                                            ...
                                            <div class="property-info-content">
                                                ...
                                                <h6><a href="property-listing-left-sidebar.html">Harmony House</a></h6>
                                                <a href="poperty-deatils1.html" class="view-details">
                                                    <img src="assets/img/dashboard/icon/view-details-icon.svg" alt="">
                                                    View Details
                                                </a>
                                    ...
                                    <td data-label="Property Info">
                                        <div class="property-info-wrapper">
                                            ...
                                            <div class="property-info-content">
                                                ...
                                                <h6><a href="property-listing-left-sidebar.html">Sunflower Cottage</a></h6>
                                                <a href="poperty-deatils1.html" class="view-details">
                                                    <img src="assets/img/dashboard/icon/view-details-icon.svg" alt="">
                                                    View Details
                                                </a>
                                    ...
                                    <td data-label="Property Info">
                                        <div class="property-info-wrapper">
                                            ...
                                            <div class="property-info-content">
                                                ...
                                                <h6><a href="property-listing-left-sidebar.html">Sunset Retreat</a></h6>
                                                <a href="poperty-deatils1.html" class="view-details">
                                                    <img src="assets/img/dashboard/icon/view-details-icon.svg" alt="">
                                                    View Details
                                                </a>
            ...
            <div class="col-xl-3 col-lg-5">
                <div class="property-details-img">
                    <div class="property-details-content">
                        ...
                        <a href="product-details.html" class="primary-btn3">View Details</a>
                    </div>
                </div>
